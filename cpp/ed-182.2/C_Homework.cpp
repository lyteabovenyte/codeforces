...
void solve() {
    ...
    vector<pair<char, int>> freq_vec(all(freq));
    sort(all(freq_vec), [](const pair<char, int>& a, const pair<char, int>& b) {
    ...
    set<char> distinct_chars(all(s));
    cout << sz(distinct_chars) << "\n";
    cout << s << "\n";
}
